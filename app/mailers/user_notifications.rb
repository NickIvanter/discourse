  ...
  def digest(user, opts={})
    ...
    if @popular_topics.present?
      opts = {
        ...
        subject: @featured_topics.length > 0 ? @featured_topics[0].title : I18n.t('user_notifications.digest.subject_template', site_name: @site_name, date: short_date(Time.now)),
        add_unsubscribe_link: true,
        unsubscribe_url: "#{Discourse.base_url}/email/unsubscribe/#{@unsubscribe_key}",
      }
